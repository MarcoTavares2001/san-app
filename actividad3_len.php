...
<html>
    ...
    <body>
        <nav class="menu lenguaje">
            ...
            <?php if($materia->verificar_act($_SESSION['id'], 'lenguaje', 'act3')){ ?>
            <a id="download"><i class="fas fa-paper-plane"></i></a>
            <?php } ?>
        </nav>
        <div class="contenedor lenguaje">
           <h4>Actividad 3. Canto "Burbujas"</h4>
           <span>Repite la canción y ayuda al bebe a hacer muchas burbujas dibujando círculos.
                <i class="fas fa-volume-up instrucciones"></i>
           </span>
           <div class="center-flex">
                <span><i class="fas fa-music"></i><br>
                    Hay burbujas en el aire, en el aire, <br>
                    hay burbujas en el aire por doquier, <br>
                    hay burbujas en el aire, hay burbujas por doquier <br>
                    hay burbujas en el aire por doquier. <br>
                </span>
    ...
    <script>
        fondo.src = 'public/img/dibujarBurbujas.png';
        fondo.crossOrigin = "anonymous";
        fondo.onload = function(){
            context.drawImage(fondo, 0, 0, canvas.width, canvas.height);
        }
        const cancion = cargarSonido("public/sound/burbujasAire.mp3");
        ...
        enviar(<?=$_SESSION['id']?>, "lenguaje", "act3", "<?=$_SESSION['nombre']?>");
    </script>
</html>
