...
<html>
    ...
    <script>
        fondo.src = 'public/img/dibujarPoema.png';
        fondo.crossOrigin = "anonymous";
        fondo.onload = function(){
            context.drawImage(fondo, 0, 0, canvas.width, canvas.height);
        }
        const cancion = cargarSonido("public/sound/veranoPoema.mp3");
        ...
        enviar(<?=$_SESSION['id']?>, "lenguaje", "act1", "<?=$_SESSION['nombre']?>");
    </script>
</html>
