...
<html>
    ...
    <body>
        ...
        <div class="contenedor matematicas">
           <h4>Actividad 4. Número.</h4>
           <span>Cuenta las velas que tiene el primer pastel y dibuja la misma cantidad de velas en el pastel que no tiene. Colorea.
    ...
    <script>
        fondo.src = 'public/img/dibujarVelas.png';
        fondo.crossOrigin = "anonymous";
        fondo.onload = function(){
            context.drawImage(fondo, 0, 0, canvas.width, canvas.height);
        }
        enviar(<?=$_SESSION['id']?>, "matematicas", "act1", "<?=$_SESSION['nombre']?>");
    </script>
</html>
