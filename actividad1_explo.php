...
<html>
    ...
    <body>
        <nav class="menu exploracion">
            ...
            <?php if($materia->verificar_act($_SESSION['id'], 'exploracion', 'act1')){ ?>
            <a id="download"><i class="fas fa-paper-plane"></i></a>
            <?php } ?>
        </nav>
        <div class="contenedor exploracion">
           <h4>Actividad 1. En busca de animales en el jardín.</h4>
           <span>Observa y busca en el patio algunos animales. ¿Qué animales hay?. Dibuja los animales que encontraste.
    ...
    <script>
        ...
        enviar(<?=$_SESSION['id']?>, "exploracion", "act1", "<?=$_SESSION['nombre']?>");
    </script>
</html>
